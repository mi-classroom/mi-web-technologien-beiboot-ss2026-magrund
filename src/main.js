...
import {
  createPoseRenderer
} from "./renderer/poseRenderer.js";

import {
  createHandRenderer
} from "./renderer/handRenderer.js";
...
} from "./gesture/gestureTracker.js";

import {
  detectGestures
} from "./gesture/gestureDetector.js";
...
} from "./gesture/gestureCounter.js";
...
const forwardCountElement =
  document.getElementById("forwardCount");

const backwardCountElement =
  document.getElementById("backwardCount");

const startCountElement =
  document.getElementById("startCount");
...
const logs =
  createLogsController(logsElement);
...
async function predict() {
  ...
  let firstLeftHandLandmarks =
    null;

  let firstRightHandLandmarks =
    null;

  for (
    let i = 0;
    i < handResult.handedness.length;
    i += 1
  ) {
    const label =
