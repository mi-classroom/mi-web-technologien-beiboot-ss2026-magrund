...
function isHandShowingThumbsUp(landmarks: LandmarkList): boolean {
...
function detect(
  ...
  const leftDetected =
    isHandShowingThumbsUp(leftHandLandmarks);

  const rightDetected =
    isHandShowingThumbsUp(rightHandLandmarks);
...
export const bothThumbsUpGesture: GestureDefinition = {
  type: Gestures.bothThumbsUp,
